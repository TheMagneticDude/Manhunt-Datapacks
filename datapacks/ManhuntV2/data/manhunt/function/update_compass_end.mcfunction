...
execute as @e[team=runners] run scoreboard players operation @s manhunt_x -= @s manhunt_x_e
execute as @e[team=runners] run scoreboard players operation @s manhunt_y -= @s manhunt_y_e
execute as @e[team=runners] run scoreboard players operation @s manhunt_z -= @s manhunt_z_e
...
execute store result storage manhunt:compass_data X int 1 run scoreboard players get @e[tag=manhunt_closest,limit=1] manhunt_x_e
